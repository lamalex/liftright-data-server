# Benchmark of a6f3561-1, graph-cleanup-ce820f1-1
## General Info & Checks
|Check|a6f3561-1|graph-cleanup-ce820f1-1|
|---|---|---|
|Docker image size (MB)|111|111|
...
|Startup time (to start responding) secs|**0.00474**|**0.00314**|
